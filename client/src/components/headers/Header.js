...
import { faSignInAlt,faClipboard,faSignOutAlt,faMap,faCoffee} from '@fortawesome/free-solid-svg-icons'
...
<nav className="navbar navbar-expand-lg navbar-dark bg-dark ">
  <Link className="navbar-brand" to="/">Blog<i><FontAwesomeIcon icon={faCoffee} /></i>Anto</Link>
